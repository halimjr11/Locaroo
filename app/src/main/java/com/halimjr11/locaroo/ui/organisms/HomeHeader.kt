...
fun HomeHeader(
    ...
    Column(Modifier.padding(all = 16.dp)) {
        TopBarProfile(name = userName, onAboutClick = onAboutClick, aboutIcon = painterResource(R.drawable.ic_user), favoriteIcon = painterResource(R.drawable.ic_favorite), onFavoriteClick = onFavoriteClick)
        Spacer(
