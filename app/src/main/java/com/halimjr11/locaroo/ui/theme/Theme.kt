...
/**
 * A composable function that applies the Locaroo theme to the given content.
 *
 * @param darkTheme Whether to use the dark theme. Defaults to `isSystemInDarkTheme()`.
 * @param dynamicColor Whether to use dynamic colors. Defaults to true. Dynamic colors are available on Android 12+.
